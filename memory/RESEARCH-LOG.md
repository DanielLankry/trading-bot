...
### Account Snapshot (as of Jul 2 EOD — last tradeable data)
- **Equity:** $97,974.55 | **Cash:** $94,467.61 (96.4%) | **Long MV:** $3,506.94 | **Daytrade count:** 0
- **Phase P&L:** −$2,025.45 (−2.03% vs $100K start)
- **Positions:** 1/4 | **Slots open:** 3 | Leveraged ETF: 0/1 | Type 4 probes: 0/2

| Ticker | Shares | Entry | Last Close | Unrealized P&L | Stop | Type | Notes |
|--------|--------|-------|-----------|----------------|------|------|-------|
| NVDA | 18 | $194.052 | $194.83 | +$14.00 (+0.40%) | Fixed GTC `62d09a4e` $191.50 | Type 1 SMA 150/200 pullback | No time stop; stop = $3.33 above stop level (1.71% buffer) |

### Market Context
| Indicator | Value | Signal |
|-----------|-------|--------|
| S&P 500 futures (holiday) | 7,549–7,551 (+0.28–0.30%) | Mild positive — holiday-thin |
| Nasdaq 100 futures | 29,673 (+0.40%) | Tech holding |
| VIX | 16.15 (Jul 2 close) | ✅ GREEN — all 5 setup types active |
| WTI crude | ~$69/bbl | Deflationary tailwind for tech/growth |
| Brent crude | ~$73/bbl | Neutral |

**Macro mode: ALL 5 SETUP TYPES ACTIVE** — SPY/QQQ above SMA 50 confirmed ✓ | VIX 16.15 < 25 ✓

### Key Catalysts — Week of July 7, 2026
1. **FOMC Minutes — Tuesday Jul 7, 7:00 PM ET** — June meeting minutes; Warsh hawkish tone (PCE 3.4% YoY, potential Sept rate hike); could re-price rate expectations. Risk event for growth stocks.
2. **ISM Services PMI — Monday Jul 6, 10:00 AM ET** — First economic data of the week; service-sector health signal.
3. **S&P Global Services PMI final — Monday Jul 6, 9:45 AM ET** — Secondary read.
4. **US-Iran hostilities resolved (late Jun 29)** — Ceasefire announced; drove S&P +20.86% H1 gain; bullish backdrop entering Q3.
5. **Q2 earnings season begins mid-July** — GOOGL Jul 28, META Jul 29, AMZN/AAPL Jul 30, NVDA Aug 26. This week is light — no universe earnings Jul 7-11.
6. **JPMorgan raised S&P target to 7,800** (+5% from current ~$7,500) — "Blue Sky" scenario based on Iran resolution + AI supercycle.
7. **Delta Air Lines (DAL)** reports Q2 Friday Jul 11 BMO — macro travel demand read.

### NVDA Position Thesis Check (Jul 3)
- **Price:** $194.83 (Jul 2 close). Fixed stop $191.50 — buffer $3.33 (1.71%). **TIGHT.**
- **SMA 150:** ~$191–193 confirmed (Finbox Jul 2). NVDA above SMA 150 by ~$1–3 ✓
- **SMA 200:** ~$171 (research) / $190.94 (Barchart) — conflicting; Jun 30 entry confirmed above SMA 200
- **Catalysts:** No scheduled events Jul 7–11. News flow: Blackwell/Vera Rubin demand, China H200 licensing (positive swing factor if approved), sovereign AI deployments (Palantir/Nemotron Jun 29 blog). Goldman PT $285; DA Davidson PT $300; 61-analyst consensus $301.62. NVDA FY2026 revenue $215.94B (+65% YoY).
- **Earnings:** Aug 26, 2026 (>5 trading days ✓)
- **Thesis:** INTACT. AI/data-center supercycle unchanged. SMA 150 floor holds.
- **Risk:** Gap-down at Jul 7 open (macro over holiday weekend, FOMC fear) could trigger $191.50 auto-stop. Buffer is 1.71% — pre-market check critical Mon morning.
- **Action: HOLD. Fixed stop $191.50 manages. Do NOT move stop.**

### Earnings — Week of July 7 (Universe)
- **No universe tickers reporting Jul 7–11.** NVDA Aug 26, GOOGL Jul 28, AMZN/AAPL Jul 30, META Jul 29 — all clear for full-size entries this week.

### Sector Context
| Sector | YTD | Trend |
|--------|-----|-------|
| Energy | +23% | Leading (sticky inflation hedge) |
| Materials | +17% | Leading |
| Industrials | +14% | Leading (AI infrastructure buildout) |
| Information Technology | −3.3% | Lagging YTD; AI semis (NVDA/AMD) bucking sector |
| Communication Services | −1.2% | Lagging |

**Key insight:** IT sector −3.3% YTD despite AI momentum in individual semis. Sector rotation headwind for broad tech. Our names (NVDA, CRWD, AMD) outperforming sector. Macro backdrop (US-Iran resolution, JPM bull target) supports Q3 continuation.

### Universe Scan — Monday Jul 7 Watchlist (Pre-Planned)
| Ticker | Last Known SMA Status | Likely Setup | Gate |
|--------|----------------------|--------------|------|
| CRWD | Above all SMAs (post 4:1 split Jul 2); strong cybersecurity RS | Type 4 Momentum Probe (post-split) or Type 2 | Check spread ≤1.5% at 9:40 AM — Day 1 spread was 7%+ |
| AMD | Stopped out Jul 2 @ $526.18. SMA 20 ~$540–550 est; SMA 50/150/200 intact | Type 1 or Type 3 if pullback to SMA 20 zone | Confirm SMA 20 level + price stable + spread ≤1.5% |
| META | +10% Jun 30 (AI cloud compute news); SMA 200 status unconfirmed at last check | Type 3/4 if above SMA 200 | Confirm SMA 200 status at open |
| TQQQ | QQQ ~5–7% above SMA 50 at Jul 2 — too extended | Type 5 — likely SKIP | QQQ must be at SMA 50 pullback zone |
| MRVL | Above SMA structure; spread historically wide | Type 4 if spread ≤1.5% | Check spread |
| PLTR | Below SMA 200 (down 36% YTD per research) | DISQUALIFIED | — |
| MSFT | Below SMA 200 per recent records | DISQUALIFIED | — |
| GOOGL | Below SMA 50 at last check | SKIP unless SMA repairs | Recheck Jul 7 |

### Trade Ideas — Monday July 7

**Idea 1 — CRWD Type 4 Momentum Probe (PRIMARY)**
- **Catalyst:** Post 4:1 split, all SMAs in Strong Buy; cybersecurity AI urgency thesis (PANW +40% YTD, cybersecurity sector rotation); spread should improve 5 days after split vs Day 1 wide market.
- **Entry gate:** Spread ≤1.5% at 9:40 AM | Above SMA 50 ($180 post-split zone) | VIX < 22
- **Size:** HALF (Type 4) — ~$9.5K
- **Stop:** 5% below entry | **Time stop:** Jul 14 (5 trading days)
- **Position cap post-entry:** 2/4 ✓ | 0 leveraged ETFs ✓ | 1/2 probes ✓

**Idea 2 — AMD Type 3 SMA 20 Re-entry (SECONDARY)**
- **Catalyst:** Wells Fargo $615 PT intact; AMD "Advancing AI 2026" event Jul 23 approaching catalyst; EPYC Venice ramp; no earnings until ~Oct 2026 ✓
- **Gate:** Confirm price at/near SMA 20 (est. $540–555) with bounce confirmation | Spread ≤1.5% | NOT entering unless clear SMA pullback structure
- **Size:** FULL (Type 3) — ~$19K | **Stop:** Daily close below SMA 20

**Idea 3 — TQQQ Type 5 Core (TERTIARY — if QQQ corrects)**
- QQQ needs to pull back to SMA 50 zone. Currently extended ~5–7% above SMA 50. Monitor on pullback days only.
- **Do NOT enter if QQQ >4% above SMA 50.**

### Risk Factors
1. **NVDA stop proximity** — $191.50, 1.71% buffer. Gap-down Monday → auto-exit. Pre-market check critical before 9:30 AM.
2. **FOMC Minutes Tue Jul 7, 7PM** — Hawkish Warsh tone could reprice rate expectations → tech headwind end of day Tuesday.
3. **CRWD spread risk** — Day 1 post-split (Jul 2) was 7%+. By Jul 7 (Day 4 post-split), spread may still be elevated. Must verify ≤1.5% before entry.
4. **Week 11 pace: 4/7 entries** — Under-pace. No trades possible today (holiday). Week 11 ends today. Week 12 = final 5 trading days (Jul 7–11); must target 7 new entries in the sprint close.
5. **IT sector lagging YTD** — Broad tech headwind. Individual semi/AI names still outperforming but macro rotation toward Energy/Materials/Industrials is a risk.
6. **Phase P&L −2.03%** — Need to rebuild carefully. High-conviction setups only; no force-trades.
7. **SPY target 7,800 (JPM)** — Bullish backdrop but rate-hike fear (Sept FOMC) limits multiple expansion for growth.

### Decision: HOLD (Market Closed) → AGGRESSIVE SCAN Monday Jul 7
- **Today:** No action possible (NYSE holiday). Stop `62d09a4e` $191.50 GTC remains active through weekend.
- **Monday Jul 7 pre-market:** Check NVDA pre-market price vs $191.50 stop. If pre-market < $192 → prepare for stop trigger at open. Do NOT move stop down.
- **Monday Jul 7 9:40 AM:** Scan CRWD spread — if ≤1.5% + above SMA 50 → Type 4 entry half-size. Check AMD SMA 20 structure. Check META SMA 200 status.
- **Week 12 target:** 7+ entries by Jul 11 (final challenge days). Rotation preferred over holding underperformers. Types 2 and 4 are the sprint tools.
- **NO-TRADE-DAY today:** Valid — NYSE closed (Rule B: macro forces no-trading). Not counted against floor.
...
| Equity | $100,790.40 |
| Cash | $89,901.40 (89.2%) |
| Buying Power | $190,691.80 |
| Long Market Value | $10,889.00 |
| Phase P&L | +$790.40 (+0.79%) |
| Daytrade Count | 1 |

### Open Positions
| Ticker | Shares | Entry | Pre-Mkt Price | Unrealized P&L | Stop | HWM |
|--------|--------|-------|---------------|----------------|------|-----|
| NVDA | 50 | $198.62 | $218.91 (bid) | +$957.99 (+9.65%) | $200.07 (10% trail GTC, order `2c99cd23`) | $222.30 |

**Open orders:** NVDA trailing stop GTC (`2c99cd23`), trail 10%, stop $200.07, HWM $222.30 — ACTIVE. qty_available = 0 (all 50 shares reserved by stop order).

**Note:** NVDA earnings-cut to 50 shares executed May 11 (sold 50 @ $214.97, realized +$811.75). Earnings May 20. No further sizing action required — already at half-size per rules.

### Market Context
| Indicator | Level | Signal |
|-----------|-------|--------|
| WTI Crude (CLM26, June) | ~$99.45/bbl (+1.41%) | Elevated; geopolitical premium; above $95 threshold |
| Brent Crude | ~$103–105/bbl (est.) | Elevated |
| S&P 500 Futures (ESM26) | ~flat, -0.03% premarket | Muted open; awaiting CPI |
| VIX | ~18.93 (May 12; May 11 close 18.38, +2.99% today) | Rising pre-CPI; below 25 → full sizing active ✓ |
| Macro Filter | SPY & QQQ above SMA 50 (confirmed prior sessions) | ALL 5 SETUP TYPES ACTIVE ✓ |
| QQQ vs SMA 50 | ~$700 vs SMA 50 ~$615 (~14% above) | TQQQ Type 5 NOT viable |

### Key Economic Releases Today
| Time ET | Event | Consensus | Impact |
|---------|-------|-----------|--------|
| **8:30 AM** | **April CPI (headline YoY)** | **+3.8%** (March: +3.3%) | **HIGHEST — day's gating event** |
| **8:30 AM** | **April CPI (core MoM)** | ~+0.3% | HIGH |
| **Tomorrow May 13** | PPI April 8:30 AM | — | HIGH |
| **Thu May 14** | Retail Sales + Trump-Xi AI Summit | — | MODERATE-HIGH |

**Earnings today (AMC — cannot enter today):**
- CSCO (Cisco) — AI networking infrastructure; beat/miss signals tech demand
- AMAT (Applied Materials) — semiconductor equipment; read-through for semi sector
- BABA (Alibaba) — China tech; gauge on trade truce impact

### Key Market Catalysts
- **CPI binary (8:30 AM):** March headline jumped 3.3% (from 2.4%); consensus 3.8% April on energy/war inflation. Hot print (>3.8% headline OR >0.3% core MoM) = risk-off, VIX spike. Cool/in-line = continuation rally. CPI resolves before market open — will set the tone.
- **US-China tariff truce:** Tariffs at 41% on Chinese goods (reduced from 145%) through Nov 10, 2026. Stable backdrop. Trump-Xi AI Summit Thu May 14 = potential positive catalyst for tech/AI names.
- **NVDA:** Vera Rubin GPU trial production June 2026; AWS/MSFT/Google shipments July 2026. TSMC April revenue +17.5% YoY. IREN partnership ($2.1B, 5GW) intact. GTC keynote June 1. Earnings May 20. AI datacenter thesis INTACT.
- **Semi sector:** AMAT earnings tonight — beats historically lift SMH/NVDA/sector. Watch for post-earnings read-through at tomorrow's open.
...
| TQQQ | Type 5 Core | — | SKIP | QQQ ~14% above SMA 50; no pullback setup |
| AMAT | All | — | SKIP | Earnings AMC tonight — cannot enter |
| CSCO | All | — | SKIP | Earnings AMC tonight — cannot enter |
| META | All | — | DISQUALIFIED | Below SMA 200 (confirmed prior scans) |
| TSLA | All | — | DISQUALIFIED | Death cross; below SMA 200 |
| PLTR | All | — | DISQUALIFIED | Below SMA 20/50/200 (confirmed May 8) |
| AMD | All | — | SKIP | Post stop-out; no fresh setup |
| SOXL/SPXL | Type 5 | — | SKIP | Underlying indices too far above SMA 50 |

### Trade Ideas

**1. NVDA — HOLD (no new action)**
- 50 shares at $198.62; trailing stop $200.07 (10% GTC, HWM $222.30)
- Earnings May 20 (8 days away) — half-size already executed May 11 ✓
- Thesis: AI capex supercycle intact; Vera Rubin on schedule; AMAT earnings tonight = potential read-through boost
- Action: HOLD. Monitor stop. Trail automatically manages risk.

**2. CRWD — Type 4 Momentum Probe (conditional, post-CPI)**
- **Catalyst:** AI cybersecurity sector leader; strong relative strength; above all major SMAs with upward slope; sector tailwinds from Fortinet earnings lift (prior week)
- **SMA structure confirmed:** Above SMA 150/200, both sloping up ✓. Price well above SMA 20/50 = momentum extension (Type 4 characteristic, not disqualifier)
- **Entry gate (ALL must pass):**
  - (a) April CPI print at 8:30 AM NOT hot (headline ≤4.0%, core MoM ≤0.4%)
  - (b) Spread at open ≤2% (was 9.1% illiquid May 8; need re-confirm)
  - (c) Price at or near new highs (not gap-down open)
- **Size:** HALF (Type 4 rule) — 1.5–2% risk = ~$1,500–2,000 max loss. At 5% stop: ~57 shares (~$30K position)
- **Stop:** 5% below entry or 1×ATR, whichever tighter
- **Target:** +10–15%; time stop **May 19** (5 trading days from today)
- **Position cap post-entry:** NVDA 50sh (1) + CRWD (2) = 2/4 total ✓; 0 leveraged ETFs ✓; 1 momentum probe ≤2 ✓

**3. TQQQ — NOT viable.** QQQ ~14% above SMA 50. No entry.

### Risk Factors
- **CPI April (8:30 AM ET) — week's #1 binary:** April consensus 3.8% YoY. Hot core (>0.4% MoM) = VIX spike, rate fears, tech selloff. NVDA's $200.07 stop provides downside protection.
- **VIX rising:** 17.19 (May 8) → 18.38 (May 11) → 18.93 (today) — upward trend. Still <25 so full sizing allowed.
- **PPI tomorrow May 13:** Back-to-back inflation prints. Type 4 time stop and hard stop mitigate.
- **AMAT/CSCO earnings tonight AMC:** Miss = semi/AI sentiment setback; NVDA stop at $200.07 provides 8.7% buffer.
- **NVDA earnings May 20 (8 days):** Position at half-size; stop manages remaining risk. No further action needed.
- **Oil at $99/bbl:** Sustained elevated oil feeds inflation narrative.
- **Day 12 of 30; 89.2% cash:** Critically underdeployed. CRWD probe is the correct deployment vehicle today — IF CPI permits.

### Decision
**CONDITIONAL TRADE — CRWD Type 4 probe AFTER CPI print at 8:30 AM.**

**Decision tree:**
1. CPI benign (headline ≤4.0%, core MoM ≤0.4%) AND VIX stays <22 → scan CRWD spread at open; if ≤2% and price near highs → **ENTER CRWD Type 4 HALF size**
2. CPI hot (headline >4.0% OR core >0.4% MoM) → **NO-TRADE-DAY** (valid macro filter reasoning)
3. CPI ambiguous/in-line → evaluate VIX reaction at open; VIX <20 → proceed; VIX 20–25 → enter at 75% half-size; VIX >25 → HOLD

**Priority at open:**
1. Check CPI print + VIX reaction
2. If benign → CRWD: check spread bid/ask; if ≤2% and price ≥$525 → buy HALF size, set 5% stop GTC
3. Log decision (trade or NO-TRADE) with CPI actual
...
- **Gate:** Confirm above SMA 150/200 at open; no earnings within 5 days (Q2 est. ~July); spread tight
- **Size:** Full size (3-4% risk) if Type 3 entry conditions met
- **Stop:** Daily close below SMA being used (20 or 50)
- Lower priority than CRWD
...
- **WTI elevated $98-100:** Sustained above $90 keeps inflation narrative alive.
- **CRWD spread was 9.1% illiquid on May 8 open:** Re-confirm spread tight today before entry.
- **Day 11 of 30, 78.7% cash:** Under-deployed. CPI/PPI binary this week creates legitimate caution.
...
- **WTI Oil:** Declining from $116 peak (May 1) to ~$102-104 (May 6 close); elevated but trend lower is constructive
- **S&P Futures:** ESM6 last quoted at 7,379.50 as of May 6 late session
...
- Earnings May 20 → **HARD DEADLINE: cut to 50 shares or exit by May 13**
- Jensen Huang CNBC appearance (May 6) reinforced AI capex supercycle narrative ✓
- AI sector momentum intact; IREN earnings today (NVDA ecosystem adjacent)
...
| PLTR | Type 1/2/3 | **DISQUALIFIED** — declining $147→$133; likely below SMA 150/200 |
...
Valid reasons:
- Zero universe tickers qualify for a new clean entry today
...
- Open orders: Trailing stop 10% GTC on NVDA (order `4a709b23`); stop $180.216; HWM $200.24

### Macro Filter
- SPY: ~$730 est.; QQQ May 5 close $681.61 | SMA 50 ~$611 → QQQ 11.5% above SMA 50 ✓
- **→ ALL 5 SETUP TYPES ACTIVE** ✓
- VIX: 17.44 (May 5 spot per CBOE, -4.65% on day); below 25 ✓ → full sizing; leveraged ETF allowed ✓

### Market Context
- **WTI:** ~$102.56 (May 6 latest); Brent: ~$110–115 est.
- **S&P 500 futures (ESM26):** 7,303.25, +16.00 (+0.22%) — green premarket
- **Key catalysts today:**
  ...
  - Samsung joins $1T club; Asia tech rally — semi read-through
  - Iran ceasefire narrative continuing → risk-on

### Trade Ideas

**1. AMD — Type 4 Momentum Probe (PRIMARY — actionable today)**
- Catalyst: Q1 2026 blowout (DC +57% YoY, non-GAAP EPS $1.37 vs $1.25, Q2 guide $11.2B). Gap-up continuation = Type 4 setup definition.
- Entry: Wait for gap to stabilize at open (first 15–30 min). Buy if price holds above $390–395.
- Stop: 5% below entry → stop ~$375–385. Risk/share ~$20.
- Size: Half size per Type 4 rules. 1.5% of $100,259 = $1,504 risk. Shares ~75.
- Time stop: 5 trading days max → **exit by May 13**
- Position cap check: NVDA (1) + AMD (2) = 2/4 total ✓
...
### Afternoon Addendum — Midday Scan
- **AMD:** Stop `6ff03a94` triggered at intraday low $402.29 (fill $403.38, ~10:20 AM ET). Realized P&L: -$985.16. Stock recovered to close $418.37 (+17.76% session). Classic post-earnings whipsaw at intraday trough. No re-entry.
- **NVDA:** Trading $204.67, HWM $207.18 hit intraday. Trailing stop auto-ratcheted to $186.46. Jensen Huang CNBC appearance positive for sentiment. Thesis fully intact.
...
### Decision
**TRADE — NVDA Type 3 SMA 20 pullback is LIVE.** All gates met: macro filter green ✓, VIX < 25 ✓, no earnings for 12 days ✓, SMA structure intact ✓, position cap 0/4 ✓. Enter at open if price confirms above SMA 20 (~$197). Stop: daily close below SMA 20. Target $225–230.

---

## 2026-04-30 — Midday Addendum (13:11 ET)
- **Positions:** None — no cuts, no stop adjustments, no thesis breaks. Cash 100%.
- **XLE** (watchlist, Type 3 candidate): Quote $59.51/$59.52 — ABOVE SMA 20 entry zone (~$56–57). Dip never materialized. No actionable entry.
- **GNRC** (Type 4 momentum probe candidate): Quote $240.54 bid / $256.93 ask — **$16 spread (6.4%) = halted/illiquid signal → SKIP per rules.**
- **Decision:** No trades taken. Continue to hold 100% cash.
...
### Decision
**HOLD → re-evaluate post-8:30 AM ET data.** GDP + Core PCE + ECI triple print is today's gating event.
...
- FOMC: decision at 2 PM ET today — **hold at 3.50–3.75% confirmed as expected** per Powell's statement; no hawkish surprise.
- No positions open — cash 100%. No action taken.
...
### Decision
**HOLD** — FOMC decision 2 PM ET today is a binary event; Core PCE follows tomorrow. No valid confirmed SMA pullback entries on watchlist. Trades this week: 0 of 3.
...
- **No action taken.** Continue to hold cash.
...
### Decision
**HOLD** — FOMC Day 1 of 2 meeting today; decision announced tomorrow Apr 29 at 2 PM ET. No valid SMA pullback entry on watchlist.
...
### Decision
**HOLD** — FOMC Wednesday is a binary risk event. No valid confirmed SMA pullback setup on watchlist stocks today.
...
### Decision
**HOLD** — Four mega-cap names (MSFT, META, GOOGL, AMZN) all report tonight AMC. Entering any of them today = earnings hold violation.

---

## 2026-05-01 — Midday Addendum (~12:00 ET)
- **NVDA:** Down ~5–6% intraday; trading $197–202 range. Approaching SMA 20 zone. Type 3 SMA 20/50 pullback thesis developing but no confirmed bounce yet.
...
### Decision
**NO-TRADE-DAY** — SMA structure unconfirmed for all Type 1–4 candidates via Perplexity; TQQQ not at SMA 50 pullback; AMD re-entry too soon post stop-out.
...
### Decision
**TRADE — CONDITIONAL.** Wait for NFP reaction at 8:30 AM ET. Priority order: PLTR (Type 3, larger size) > CRWD (Type 4, half size). If NFP severely misses and VIX spikes >25 → reduce sizing by 25%.
...
### Decision
**NO-TRADE-DAY.** Both pre-market candidates failed hard rules at open (CRWD illiquid; PLTR below SMAs). Full scan found zero qualifying setups.
